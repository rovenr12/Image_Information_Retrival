...
for (i, queryID) in enumerate(sorted(queryIDs)):
    # Fetch the relevant results for the query image
    ...
    # Perform the search and compute the total number of relevant images in the top-4 results
