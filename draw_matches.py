...
# Initialize the feature detector if the user entered as 'DOG' or 'FASTHESSIAN', use the appropriate value
...
# Match the keypoints using the Euclidean distance and initialize the list of actual matches
...
if rawMatches is not None:
    ...
    for(trainIdx, queryIdx) in matches:
        ...
        # Check to see if each match should be visualize individually
